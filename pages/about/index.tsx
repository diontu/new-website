    ...
    <LayoutOne title="About..." titleAlign="left">
      ...
      <FadeIn>
        <p>
          ...
          <br />
          <br />
          I&lsquo;ve work professionally as a frontend engineer for a little
          over 2 years at 2 of the largest banks in Canada and a smaller but
          successful B2B software company.
        </p>
      </FadeIn>
      <FadeIn delay={150}>
        <>
      ...
      <FadeIn delay={300}>
        <p>
          ...
          individuals to build performant, and maintainable web applications
          while leveling up my frontend skills. I&lsquo;ve studied 4 years in
          Software Engineering at York University in Canada and wanted to make a
          difference on frontend web applications.
        </p>
      </FadeIn>
    </LayoutOne>
  );
